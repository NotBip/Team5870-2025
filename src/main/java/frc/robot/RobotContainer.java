...
import frc.robot.Subsystems.PhysicsSim.MapleSimSwerve;
import frc.robot.Subsystems.PhysicsSim.SwerveDrive;
import frc.robot.commands.Swerve.SimSwerveCmd;
...
public class RobotContainer {
    ...
    public RobotContainer() {
        this.s_Swerve = new MapleSimSwerve();
    ...
    private void configureButtonBindings() {
        s_Swerve.setDefaultCommand(new SimSwerveCmd(
                s_Swerve,
